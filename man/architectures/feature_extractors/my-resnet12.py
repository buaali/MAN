...
import man.architectures.feature_extractors.resnet12 as resnet12
import man.architectures.feature_extractors.utils as utils
...
class ResNet(utils.SequentialFeatureExtractorAbstractClass):
    def __init__(self, arch, pool="avg"):
        ...
        if arch == "resnet12":
            net = resnet12.ResNet(resnet12.BasicBlock, [1,1,1,1], kernel=3)
        elif arch == "resnet10":
