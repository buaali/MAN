...
def preprocess_features(npdata, pca=256):
    ...
    """
    print("preprocess_features begin")
    _, ndim = npdata.shape
    ...
    #print(A.shape)
    #print(b.shape)
    #tensor_data = torch.from_numpy(npdata).cuda()
    #tensor_A = torch.from_numpy(A).cuda()
    #tensor_b = torch.from_numpy(b).cuda()
    #tensor_data = tensor_data.mm(tensor_A.t()) + tensor_b
    #npdata = tensor_data.numpy().cpu().astype('float32')
